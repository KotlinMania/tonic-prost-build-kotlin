...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `TonicProstBuild.swiftmodule/`
...
//      `import TonicProstBuild` above would fail at compile time.
//
//   2. The static archive `libTonicProstBuild.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "TonicProstBuild" }` and
//      `flattenPackage = "io.github.kotlinmania.tonicprostbuild"` configuration in
...
//      via the `TonicProstBuildLibrary` product.
//
