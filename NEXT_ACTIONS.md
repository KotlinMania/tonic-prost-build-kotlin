...
- **Function parity:** 41/59 matched (target 66) — 69.5%
- **Class/type parity:** 3/6 matched (target 8) — 50.0%
- **Combined symbol parity:** 44/65 matched (target 74) — 67.7%
...
- **Similarity:** 0.52
- **Dependents:** 0
- **Priority Score:** 115404.8
- **Functions:** 40/48 matched (target 52)
...
- **Types:** 3/6 matched (target 7)
- **Missing types:** `Method`, `Comment`, `ServiceGenerator`
...
- **Functions:** 1/11 matched (target 14)
