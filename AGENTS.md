...
This file is the quick-reference operating contract for tonic-prost-build-kotlin. The longer
...
tonic-prost-build-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tonic-prost-build`](https://crates.io/crates/tonic-prost-build). Upstream Rust is the behavioral oracle while the
